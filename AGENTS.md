...
- **Page 1 content** (`ChapterOpen` in `pages.tsx`) is a full-bleed `PeopleCloud` of 28 coworker portraits from `public/images/people/`, listed in `people.ts` with display names derived from filenames. "Chapter One" copy removed.
